...
# @Last Modified time: 2017-12-26 11:37:44


'''
In this experiment, I want to test if the optimal transformations of the covariates
...
plt.scatter(data.X[:,5], fit_stand['f'][:,5], s=0.7)
plt.show()
...
""" Observations:
The conditional variances of X given Y are small for those covariates sharing the groups.
