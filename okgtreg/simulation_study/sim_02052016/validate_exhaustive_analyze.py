...
if __name__ == "__main__":
    ...
    pkl_folder = "validate_exhaustive_model" + str(model_id) + "_02232016"
    file_name = "validate_exhaustive-model1-seed1-201602222051.pkl"
    ...
    Res = ValidateExhaustiveProcessor(pkl_file_path=sim_folder + '/' + \
                                                    pkl_folder + '/' + \
                                                    file_name,
                                      true_group_struct=true_group_struct)
