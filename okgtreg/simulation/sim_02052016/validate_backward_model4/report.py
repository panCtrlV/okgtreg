...
'''
Process the simulation results from "validate_backward.py" for Model 4.
'''
...
cwd = "okgtreg/simulation/sim_02052016/validate_backward_model4"

# Try one simulation
## Create an object
fname = "validate-model4-seed1-201602100051.pkl"
...
## Create object
allRes_model4 = ValidateResultProcessorAll(cwd, trueGroupStructure)

## print bestGroupStructures and their frequency
bestGroupStructureFreq = allRes_model4.bestGroupStructureFrequency()
...
allRes_model4.consistentSelectionFrequencyForParameters()
