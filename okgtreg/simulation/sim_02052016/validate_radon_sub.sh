#!/bin/sh -l
# FILENAME:  validate_radon_sub.sh
...
#qsub validate_radon_sub.sh

# Submit job with specified wall time (1 hour 30 min)
#qsub -l walltime=01:30:00 validate_radon_sub.sh

# Submit job with specified # nodes and # cores/node
#qsub -l nodes=2:ppn=4 validate_radon_sub.sh

# Submit job with specified # cores (free placement of nodes)
#qsub -l procs=100 -l walltime=02:30:00 validate_radon_sub.sh
